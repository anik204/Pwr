        ...
        try:
            ...
            for line, user_data in user_data_list:
                ...
                if get_token_response is not None:
                    ...
                    print(Fore.CYAN + Style.BRIGHT + f"============= [ ༒︎𝗭𝗮𝗶𝗻༒︎{nickname} ] =============", flush=True)
                    ...
                    if quizlist and quizlist.get('msg', 'Available') == 'Available':
                        ...
                        print(Fore.YELLOW + Style.BRIGHT + f"[ Quiz ]: Must join Telegram channel ")
                    else:
                    ...
                    if answer_result:
                        ...
                        print(Fore.YELLOW + Style.BRIGHT + f"[ Quiz ]: Hello, your work has been started ")
...
║  ZAIN ARAIN                        ║ 
║                                    ║ 
║  JOIN TELEGRAM CHANNEL FOR LATEST  ║ 
║  UPDATES & SUPPORT!                ║ 
